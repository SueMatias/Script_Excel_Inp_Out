...
for Ba in range(1, 8):
    for Z in range(1, 7):
        for O in range(1, 30):
            volume = open(f"/home/suellen/Documentos/IC/BAZRO_B3PW/{Ba}{Z}{O}/BZO_B3PW_{Ba}{Z}{O}_VOLUME_TROCA.txt", "r")
            parametro = open(f"/home/suellen/Documentos/IC/BAZRO_B3PW/{Ba}{Z}{O}/BZO_B3PW_{Ba}{Z}{O}_PARAMETRO_TROCA.txt", "r")
            densidade = open(f"/home/suellen/Documentos/IC/BAZRO_B3PW/{Ba}{Z}{O}/BZO_B3PW_{Ba}{Z}{O}_DENSITY_TROCA.txt", "r")
            gap = open(f"/home/suellen/Documentos/IC/BAZRO_B3PW/{Ba}{Z}{O}/BZO_B3PW_{Ba}{Z}{O}_GAP_TROCA.txt", "r")
            valor_volume = []
            valor_parametro = []
            valor_densidade = []
            valor_gap = []
