        ...
        for O in range(1, 30):
            ...
            if len(valor_gap) != 1:
                ...
                if Ba <= 4:
                    ...
                    PBE0.cell(row=4, column=column).value = valor_parametro[0]
                    print(PBE0.cell(row=4, column=column).value)

                    PBE0.cell(row=6, column=column).value = valor_gap[0]
                    print(PBE0.cell(row=6, column=column).value)

                    PBE0.cell(row=8, column=column).value = valor_densidade[0]
                    print(PBE0.cell(row=8, column=column).value)
                else:
                    PBE0.cell(row=14, column=column).value = valor_volume[0]
                    print(PBE0.cell(row=2, column=column).value)

                    PBE0.cell(row=16, column=column).value = valor_parametro[0]
                    print(PBE0.cell(row=4, column=column).value)

                    PBE0.cell(row=18, column=column).value = valor_gap[0]
                    print(PBE0.cell(row=6, column=column).value)

                    PBE0.cell(row=20, column=column).value = valor_densidade[0]
                    print(PBE0.cell(row=8, column=column).value)
