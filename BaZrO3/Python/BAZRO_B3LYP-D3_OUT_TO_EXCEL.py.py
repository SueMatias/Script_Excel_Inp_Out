...
for Ba in range(1, 8):
    for Z in range(1, 7):
        for O in range(1, 30):
            volume = open(f"/home/suellen/Documentos/IC/BAZRO_B3LYP-D3/{Ba}{Z}{O}/BZO_B3LYP-D3_{Ba}{Z}{O}_VOLUME_TROCA.txt", "r")
            parametro = open(f"/home/suellen/Documentos/IC/BAZRO_B3LYP-D3/{Ba}{Z}{O}/BZO_B3LYP-D3_{Ba}{Z}{O}_PARAMETRO_TROCA.txt", "r")
            densidade = open(f"/home/suellen/Documentos/IC/BAZRO_B3LYP-D3/{Ba}{Z}{O}/BZO_B3LYP-D3_{Ba}{Z}{O}_DENSITY_TROCA.txt", "r")
            gap = open(f"/home/suellen/Documentos/IC/BAZRO_B3LYP-D3/{Ba}{Z}{O}/BZO_B3LYP-D3_{Ba}{Z}{O}_GAP_TROCA.txt", "r")
            valor_volume = []
            valor_parametro = []
            valor_densidade = []
            valor_gap = []
            ...
            if len(valor_gap) != 1:
                ...
                if Ba <= 4:
                    ...
                    B3LYP_D3.cell(row=14, column=column).value = valor_volume[0]
                    print(B3LYP_D3.cell(row=2, column=column).value)

                    B3LYP_D3.cell(row=16, column=column).value = valor_parametro[0]
                    print(B3LYP_D3.cell(row=4, column=column).value)

                    B3LYP_D3.cell(row=18, column=column).value = valor_gap[0]
                    print(B3LYP_D3.cell(row=6, column=column).value)

                    B3LYP_D3.cell(row=20, column=column).value = valor_densidade[0]
                    print(B3LYP_D3.cell(row=8, column=column).value)
